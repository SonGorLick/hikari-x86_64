...
```sh
dracut --kver 5.19.6-hikari-x86_64 /boot/initramfs-5.19.6-hikari-x86_64.img --force
```
...
efibootmgr --create \
           ...
           --loader '\vmlinuz-5.19.6-hikari-x86_64' \
           -u 'loglevel=4 initrd=\initramfs-5.19.6-hikari-x86_64.img'
```
