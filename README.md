## <p align="center">`5.13.1-kurisu-x86_64`</p>
...
**With initramfs**
```sh
efibootmgr --create --part 1 --disk /dev/sda --label "GENTOO_kurisu-x86_64" --loader "\vmlinuz-5.13.1-kurisu-x86_64" \
-u "loglevel=4 initrd=\initramfs-5.13.1-kurisu-x86_64.img"
```
